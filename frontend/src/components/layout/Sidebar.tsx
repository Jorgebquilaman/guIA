...
function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-40 flex h-full w-[260px] flex-col overflow-hidden text-iupa-green-light transition-transform duration-300 -translate-x-full ${
          !sidebarCollapsed && sidebarOpen ? 'translate-x-0' : ''
