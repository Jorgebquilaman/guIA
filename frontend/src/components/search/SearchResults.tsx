...
export default function SearchResults({
    ...
    return (
      <div className="space-y-4">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="animate-pulse rounded-lg border border-iupa-light bg-white p-5 shadow-sm"
          >
  ...
  if (!results || results.items.length === 0) {
    return (
      <div className="rounded-lg border border-iupa-light bg-white p-12 text-center shadow-sm">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-iupa-green-light to-iupa-green/10 shadow-sm">
          <svg
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 rounded-lg border border-iupa-light bg-white px-4 py-2.5 text-sm text-iupa-medium shadow-sm">
