...
namespace GuIA.Infrastructure.Migrations
{
    ...
    [Migration("20260924143454_AddAuthorMetadata")]
    partial class AddAuthorMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuIA.Domain.Entities.AccessCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("access_categories", (string)null);
                });
            ...
            modelBuilder.Entity("GuIA.Domain.Entities.AuthorMetadataField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("author_metadata_fields", (string)null);
                });

            modelBuilder.Entity("GuIA.Domain.Entities.AuthorMetadataFieldOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AuthorMetadataFieldId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AuthorMetadataFieldId");

                    b.ToTable("author_metadata_field_options", (string)null);
                });

            modelBuilder.Entity("GuIA.Domain.Entities.AuthorMetadataSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("author_metadata_settings", (string)null);
                });
            ...
            modelBuilder.Entity("GuIA.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("AuthorizesPublication")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime?>("DataConsentAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DataConsentText")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("GuIA.Domain.Entities.UserAuthorMetadataValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_author_metadata_values", (string)null);
                });
            ...
            modelBuilder.Entity("GuIA.Domain.Entities.AuthorMetadataField", b =>
                {
                    b.HasOne("GuIA.Domain.Entities.AccessCategory", "AccessCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("GuIA.Domain.Entities.AuthorMetadataFieldOption", b =>
                {
                    b.HasOne("GuIA.Domain.Entities.AuthorMetadataField", "Field")
                        .WithMany("Options")
                        .HasForeignKey("AuthorMetadataFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GuIA.Domain.Entities.User", b =>
                {
                    b.Navigation("AuthorMetadataValues");
