...
public record GetMetadataSchemaByIdQuery(Guid Id) : IRequest<MetadataSchemaDto?>;

public class GetMetadataSchemaByIdQueryHandler : IRequestHandler<GetMetadataSchemaByIdQuery, MetadataSchemaDto?>
{
    private readonly IAppDbContext _context;

    public GetMetadataSchemaByIdQueryHandler(IAppDbContext context)
    {
        _context = context;
    }

    public async Task<MetadataSchemaDto?> Handle(GetMetadataSchemaByIdQuery request, CancellationToken ct)
    {
